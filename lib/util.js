...
exports.merge = exports.defaultsDeep = exports.filter = exports.map = exports.mixin = exports.each = exports.find = exports.mapValues = exports.isPlainObject = exports.isArray = exports.isFunction = exports.isRegExp = exports.isString = undefined;
...
function logger(func, level, msg) {
  ...
  return stdout[func].apply(stdout, [levelColor.debug(getTime()), levelColor[level](`[${ level.toUpperCase() }]`)].concat(_toConsumableArray(msg)));
}
// 显示内部运行时信息
function debug() {
